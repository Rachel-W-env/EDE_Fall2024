...
GaringerOzone.daily.ts <- ts(Garinger_data_clean$Clean.Ozone, start=c(f_year,f_month), frequency=365)

GaringerOzone.monthly.ts <- ts(GaringerOzone.monthly$mean_concentration, start=c(f_year2, f_month2), frequency=12)
...
> Answer: Ozone has been slightly decreasing over time at this station. Ozone 
is higher in the summer months than the winter months. (tau = -0.143,
2-sided pvalue =0.046724). 
