...
mytheme <-theme_classic(base_size = 14) +
  theme(axis.text = element_text(color = "black"), 
        legend.position = "top", plot.background =   element_rect(color="gray"), plot.title=element_text(size=16, face="bold", hjust=.5))
...
ggplot(
    aes(
      x=tp_ug,
      y=po4)
    ) + ggtitle("Phosphorus vs. Phosphate")  + xlab("Total Phosphorus") + ylab("Total Phosphate") +
  mytheme 
PhosGraph
```
