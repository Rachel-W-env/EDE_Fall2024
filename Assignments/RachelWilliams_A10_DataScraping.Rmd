...
"Date"= mutate(as.Date(my(paste(Month,"-",the_year)))))
...
ggplot(Durham, aes(x=Month, y=MGD)) +
  geom_line() + geom_smooth(method = "lm", col = "blue")
...
ggplot(combined_data, aes(x=Month, y=MGD, color=PWSID)) +
  geom_line() 
