...
# Sample PWSIDs from the Asheville data (subset facilities)
Asheville_subset <- sample(Asheville$PWSID, 5)

# Create a vector for years 2018 to 2022, repeated for each PWSID
the_years <- rep(2018:2022, each = length(Asheville_subset))

# Map the "scrape.it" function to retrieve data for all combinations of PWSID and year
Asheville_2018_2020 <- map2(the_years, rep(Asheville_subset, times = 5), scrape_it) %>% bind_rows()

#Conflate the returned list of dataframes into a single one
Asheville_2018_2020 <- bind_rows(dfs_2020) 


```

Question: Just by looking at the plot (i.e. not running statistics), does Asheville have a trend in water usage over time?
> Answer: By looking at the plot, Asheville appears to be decreasing in water usage over time. 
>
