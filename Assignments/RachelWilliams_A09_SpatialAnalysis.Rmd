...
> ANSWER: The EPSG code of the counties dataset is 4269. This is NAD83 and it 
is a geodetic corrdinate reference system. It is also a datum. 
...
geom_sf(data = counties_sf, fill = "lightgray") +
  geom_sf(data=lancaster, fill="yellow") +
    geom_sf(data=gage_15, col="blue") +
  geom_sf(data=Lancaster_gage, col="black")
