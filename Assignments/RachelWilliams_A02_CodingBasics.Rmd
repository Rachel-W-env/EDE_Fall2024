...
> Answer: This is different than a matrix because it can combine different types of data.
#matrices are only numerical. 
...
means it will not operate on all elements of a vector without looping. 
