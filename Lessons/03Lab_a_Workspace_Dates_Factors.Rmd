...
Lake_ChemistryPhysics <- read.csv(
...
#L is short for long integer, meaning it supports a long array of values
#Alternative 1
...
#dim shows how many rows and columns are in the dataset
...
#Shows only the 4th, 5th, and 3rd day of the week are in the dataset
unique(sites$dow)
